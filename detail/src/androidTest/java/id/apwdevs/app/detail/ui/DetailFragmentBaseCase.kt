...
abstract class DetailFragmentBaseCase: BaseAndroidTest() {
     ...
     */
    @Test abstract fun should_decide_the_right_ui_helper_from_intent()

    @Test open fun should_display_data_when_success() {
        launchFragment()
    ...
    @Test fun should_display_error_when_request_failing() {
    ...
    @Test fun should_reload_data_when_click_retry_button(){
    ...
    @Test fun should_favorite_button_hide_and_favoritemenu_show_when_scroll_up() {
        launchFragment()
        "favorite_fab".thisViewMustBeDisplayed()
    ...
    @Test fun should_change_favorite_icon_after_adding_and_remove_favorite() {
        launchFragment()
        // add to favorite
        "favorite_fab".thisViewMustBeDisplayed()
    ...
    protected fun launchFragment(pageType: PageType = defaultPageType, itemId: Int = defaultItemId): DetailItemFragment {
