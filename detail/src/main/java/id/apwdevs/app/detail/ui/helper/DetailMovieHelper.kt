...
class DetailMovieHelper(private val fragmentManager: FragmentManager, onRetry: () -> Unit) : DetailItemHelper(onRetry) {

    private lateinit var contentBinding: ContentDetailMovieBinding
    private var backdropImageSection: Fragment? = null

    override fun initView() {
        contentBinding = ContentDetailMovieBinding.inflate(LayoutInflater.from(rootBinding.root.context), rootBinding.nestedScroll, false)
