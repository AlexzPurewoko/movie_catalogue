...
//                    _data.value = Resource.Success(generated)
    ...
    private fun composeEpisode(lastEpisodeToAir: EpisodeToAir): EpisodeItemData {
        return EpisodeItemData(lastEpisodeToAir.stillPath, lastEpisodeToAir.name, lastEpisodeToAir.voteAverage, lastEpisodeToAir.airDate, lastEpisodeToAir.seasonNumber)
    }
    ...
    private suspend fun isInFavorite(id: Int, isMovie: Boolean) = favoriteUseCase.checkIsInFavorite(id, isMovie)
