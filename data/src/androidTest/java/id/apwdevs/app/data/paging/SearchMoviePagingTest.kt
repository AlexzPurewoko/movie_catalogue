...
class SearchMoviePagingTest {
    ...
    @Test fun should_success_retrieve_data_when_scrolldown_and_reached_treshold() {
        runBlocking {
            val job = executeLaunch(this)
            delay(1000)
    ...
    @Test fun should_not_get_data_again_when_pagination_end() {
        runBlocking {
            val job = executeLaunch(this)
    ...
    @Test fun should_success_get_data_when_scrollup_from_end() {
        runBlocking {
    ...
    @Test fun should_refreshed_if_calling_refresh() {
        runBlocking {
