...
class SearchTvShowPagingDispatcher(
    ...
    private val mappingRequest = mapOf(
        "/search/tv?api_key=${Config.TOKEN}&page=1&query=A&include_adult=false" to AssertData.TVSHOW_PAGE_1,
        "/search/tv?api_key=${Config.TOKEN}&page=2&query=A&include_adult=false" to AssertData.TVSHOW_PAGE_2,
        "/search/tv?api_key=${Config.TOKEN}&page=3&query=A&include_adult=false" to AssertData.TVSHOW_PAGE_3,
    )
