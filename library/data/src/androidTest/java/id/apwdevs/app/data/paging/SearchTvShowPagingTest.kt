...
//    }
    ...
    private val adapter: RecyclerTestAdapter<TvShowItemResponse> by lazy {
        RecyclerTestAdapter()
    }

    private lateinit var pager: Flow<PagingData<TvShowItemResponse>>
    ...
    fun setup(){
        ...
        mockWebServer.dispatcher = SearchTvShowPagingDispatcher(context, ::receiveCallback)
        pager = Pager(
            config = PagingConfig(
                pageSize = 20,
            ...
            pagingSourceFactory = { SearchTvShowPagingSource(service, query) }
        ).flow
    }
