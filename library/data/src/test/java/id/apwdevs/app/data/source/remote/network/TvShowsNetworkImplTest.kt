...
class TvShowsNetworkImplTest {
    ...
    lateinit var tvShowsNetworkImpl: TvShowsNetworkImpl
    ...
    @Test fun `should call getPopularTvShows from api source`(){
        runBlocking {
    ...
    @Test fun `should call getDetailTvShow from api source`(){
        runBlocking {
    ...
    @Test fun `should call searchTvShow from api source`(){
        runBlocking {
    ...
    @Test fun `should call getTvShowsGenre from api source`(){
        runBlocking {
